...
describe('manifest', function () {
    ...
    it('should generate diffPackageMap', function () {
        ...
        const upload = (blob)=> {
            if (blob.outputStream) {
                return zipToBuf(blob).then(function (zip) {
                    const url = shasum(zip);
                    return {
                        size: zip.length,
                        url
                    };
        ...
        return manifest.diffPackageMap(download, upload, test).then(eql([
            {
                ...
                "size": 206162,
                "manifestBlobUrl": "https://codepush.blob.core.windows.net/storagev2/2rX1YrLdg8T_4fCjinFOCKPcqabJEy9mceh0-",
            ...
            },
            {
                ...
                "size": 206171,
                "manifestBlobUrl": "1fae80aa5e6a9bca527f4c4107bd3d47b741604f0fe12cb68ad600fa532edf47",
                "releaseMethod": "Upload",
