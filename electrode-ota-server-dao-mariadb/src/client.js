...
export const createDatabaseForTest = (options) => {
    ...
    if (process.env.NODE_ENV == "production") {
        throw new Error("testCreateDatabase() should not be called in production; only in test");
    }
    return client.query(`DROP DATABASE IF EXISTS ${db}`)
...
export default class DaoMariaDB {
    ...
    async init() {
        ...
        Object.assign(this, {
            ...
            Deployment: ProxyModelWrapper(this.sequelize, this.sequelize.models.Deployment),
            ...
            PackageContent: ProxyModelWrapper(this.sequelize, this.sequelize.models.PackageContent),
