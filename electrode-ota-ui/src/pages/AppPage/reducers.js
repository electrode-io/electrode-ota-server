...
import {ADDED_COLLABORATOR, REMOVED_COLLABORATOR} from '../Collaborator/actions';
import {ADDED_DEPLOYMENT, RENAMED_DEPLOYMENT, REMOVED_DEPLOYMENT} from '../Deployment/actions';
...
export const selectedApp = (state = {}, {type, value, isError, error})=> {
    switch (type) {
        ...
        case RENAMED_APP:
            ...
            return {...state, isFetching: false, isError: false, isStale: Date.now()};
